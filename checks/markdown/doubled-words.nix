...
#   - checks/markdown/split-code-spans.nix reasons about backtick pairing, not word
#     sequences.
#
...
# ./markdown-scan.nix, shared with checks/markdown/split-code-spans.nix.
#
...
{pkgs, ...}: {
  checks.doubled-words = (import ./markdown-scan.nix {inherit pkgs;}) {
