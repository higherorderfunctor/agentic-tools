...
def strip_code_blocks(lines):
    ...
    any number here, and see checks/markdown/doubled-words-fixtures.nix for the
...
def no_files(name):
    ...
    corpus. checks/markdown/markdown-scan.nix already refuses to invoke a scanner
    ...
    print("responsible for the file list; see checks/markdown/markdown-scan.nix for", file=sys.stderr)
