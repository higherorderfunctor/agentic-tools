...
# the two extensionless hooks under `packages/claude-code/checks/fixtures/claude-hooks/`.
#
...
# checks/markdown/markdown-scan.nix: a scan of nothing exits 0 and is indistinguishable
