...
# question, asserted in packages/copilot-cli/checks/module-eval.nix.
{
  lib,
  pkgs,
  ...
}: {
  checks.copilot-wrapper-argv = let
    wrapCopilotPackage = import ../lib/wrapPackage.nix {inherit lib pkgs;};
