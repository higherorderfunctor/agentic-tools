...
#
# Structurally identical to packages/fblog/packages/ai/generic/fblog/package.nix, including the
...
# consume the way packages/semble/packages/ai/semble/package.nix consumes one. An overlay plus a
