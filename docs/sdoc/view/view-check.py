...
walked to map each UID to its file until the daemon-exported path from R2 is
combined: a narrative's directory class (spec, plan:<name>, package) is what
the over-in-plan-or-spec rule compares.
"""
