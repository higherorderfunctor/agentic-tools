...
| #144 mcp-proxy ver   | C    | `rev`, `src.hash`                                    | Open the PR red — every hash resolved; see the 2026-09-09 note above            | Leftover dead-code `CI_MODE` guard on `run_build` (`update-common.sh:91-97`) — local mode is deprecated                      |
