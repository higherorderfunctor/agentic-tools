---
applyTo: ".github/actions/warm-ifd/**,.github/workflows/ci.yml,.github/workflows/devenv-test.yml,.github/workflows/update.yml,overlays/*.nix,overlays/**/*.nix,packages/*/packages/**"
---
