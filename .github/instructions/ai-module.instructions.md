---
applyTo: "checks/module-eval.nix,lib/ai/agent.nix,lib/ai/ai-common.nix,lib/ai/app/**,lib/ai/default.nix,lib/ai/hooks.nix,lib/ai/materialize.nix,lib/ai/mkSkillPackageModule.nix,lib/ai/program.nix,lib/ai/runtimes.nix,lib/ai/runtime-files.nix,lib/ai/sharedOptions.nix,packages/chatgpt-codex/lib/mkCodex.nix,packages/claude-code/lib/mkClaude.nix,packages/copilot-cli/lib/mkCopilot.nix,packages/kimchi/lib/mkKimchi.nix,packages/kiro-cli/lib/mkKiro.nix,packages/chatgpt-codex/modules/**,packages/claude-code/modules/**,packages/copilot-cli/modules/**,packages/kiro-cli/modules/**,packages/semble/modules/common.nix"
---
