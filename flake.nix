{
  ...
  in {
    ...
    checks = forAllSystems (system: let
      ...
      daemonOnlySourceCheck = {daemon-only-source = import ./checks/daemon-only-source.nix {inherit pkgs self;};};
      ...
      interpreterLaunchersCheck = {interpreter-launchers = import ./checks/interpreter-launchers.nix {inherit pkgs self;};};
      ...
      strictdocRuntimeInstallationCheck = {strictdoc-runtime-installation = import ./checks/strictdoc-runtime-installation.nix {inherit lib pkgs self;};};
